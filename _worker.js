...
// 设置优选地址api接口
let addressesapi = [
	'https://raw.githubusercontent.com/dilidaladi/WorkerVless2sub/main/addressesapi.txt' //可参考内容格式 自行搭建。
	'https://addressesapi.090227.xyz/CloudFlareYes',
];

let DLS = 4;//速度下限
let addressescsv = [
	//'https://raw.githubusercontent.com/dilidaladi/WorkerVless2sub/main/addressescsv.csv' //iptest测速结果文件。
];
